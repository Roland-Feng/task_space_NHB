...
for level in range(1,2):
    ...
    save_obj(cp_all, f'threshold_cp_all_{level}_2', data_path_save + f'jobs/{data_label}/')
...
for level in range(1,2):
    ...
    df.to_csv(data_path_save + f'jobs/{data_label}/threshold_{period_label}_{so_yearlist_salary}_{sv_yearlist_salary}_df_regression_level_{level}_topn_{topn}_{sample_user_label}_2.csv')
