...
def bert_skill_embedding_regression_threshold(job_skill_dataset, data_path_save, device, data_label):
    ...
    save_obj(occupation_skill_embedding,f'threshold_regression_job_skill_embedding', data_path_save + f'jobs/{data_label}/')
    return


def bert_tag_embedding_regression_threshold(community_unweighted_level, data_path_save, device, level, data_label):
    from sentence_transformers import SentenceTransformer
    ...
    save_obj(tag_embedding, f'threshold_regression_tag_embedding_level_{level}', data_path_save + f'jobs/{data_label}/')
    return


def occupation_task_distance_matrix_regression_threshold(occupation_embedding_dict, community_unweighted_level, community_list_std, data_path_save, level, tag_count_dict, tag_count_bool, data_label):
    ...
    tag_embedding = load_obj(f'threshold_regression_tag_embedding_level_{level}', data_path_save + f'jobs/{data_label}/')
    ...
    save_obj(occupation_task_similarity_matrix, f'threshold_regression_job_task_similarity_matrix_level_{level}', data_path_save + f'jobs/{data_label}/')
...
def build_regression_dataframe_threshold(data_path_save,level,community_list_std,community_unweighted_level,skill_similarity_threshold,skill_length_threshold,so_year_list, task_salary_name, data_label, density_user_label, salary_type = 'mean'):
    ...
    occupation_task_similarity_matrix = load_obj(f'threshold_regression_job_task_similarity_matrix_level_{level}', data_path_save + f'jobs/{data_label}/')
